    ...
    return Scaffold(
      body:GridView.builder(gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        ...
        padding: const EdgeInsets.all(8.0),
         itemBuilder: (context, index)=>
         PositionWidget(link: photo[index],),
         ),
    );
  }
}
...
class _VWidgetState extends State<VWidget> {
 ...
 @override
  void initState() {
    _controller = VideoPlayerController.networkUrl(Uri.parse('https://cdn.pixabay.com/video/2023/01/25/147898-792811387_large.mp4'),);
        ...
        child: Padding(
          ...
          child: Stack(
              children: [
                  ...
                  return Container(
                  margin: EdgeInsets.symmetric(horizontal: 20,vertical: 30),  // Adds margin around the video
                  child: ClipRRect(
